package com.crh.admin.controller.interceptor;

import com.crh.admin.controller.annotation.PermessionLimit;
import com.crh.admin.core.util.CookieUtil;
import com.crh.admin.core.util.PropertiesUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    static {
        String username = PropertiesUtil.getString("crh.login.username");
        String password = PropertiesUtil.getString("crh.login.password");
